    ...
    {!! Form::open(['method' => 'PUT', 'route' => ['text.update']]) !!}
        ...
        <tbody>
          ...
          <input id="afpsn" name="afpsn" type="hidden" value="{{$result->afpsn}}">
            ...
            <td>{{ $result->pension_rank }}</td>

            <td>
            <select class="browser-default" placeholder="Transactions" id="trxns" name="trxns" class="validate" value="{{$result->trxns}}" required>
            ...
            <td>
            <select class="browser-default" placeholder="Type of Process" id="type_of_process" name="type_of_process" class="validate" value="{{$result->type_of_process}}" required>
            ...
            <td>
            <select class="browser-default" placeholder="Remarks" id="remarks" name="remarks" class="validate" value="{{$result->remarks}}" required>
                <option value="" disabled selected>Process Type</option>
            ...
            <td><input placeholder="Contact No." id="contact_no" name="contact_no" class="validate" value="{{$result->contact_no}}" required></td>
            
           <!-- <input id="concatenated" name="concatenated" type="hidden" value="{{$result->remarks}}" value="{{$result->contact_no}}"> -->
