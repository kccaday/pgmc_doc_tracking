...
unset($__errorArgs, $__bag); ?></span>
        ...
        <div class="form-group input-field col s6">
          ...
          <select class="browser-default" placeholder="Transactions" id="transaction_type" name="transaction_type" class="validate" value="<?php echo e(old('transaction_type')); ?>" required>
                ...
                <option value="36-months Lumpsum">DV - 36-months Lumpsum</option>
                <option value="Closed/Invalid Accounts">DV - Closed/Invalid Accounts</option>
                <option value="Commutation of TAS">DV - Commutation of TAS</option>
                <option value="Direct Pension">DV - Direct Pension</option>
                <option value="Incorporation">DV - Incorporation</option>
                <option value="Living Claims">DV - Living Claims</option>
                <option value="Local Pickup">DV - Local Pickup</option>
                <option value="One time payment (Monies)">DV - One time payment (Monies)</option>
                <option value="Overpaid/Underpaid">DV - Overpaid/Underpaid</option>
                <option value="Own Rights">DV - Own Rights</option>
                <option value="Restoration">DV - Restoration</option>
                <option value="Resumption of Pension">DV - Resumption of Pension</option>
                <option value="Separation Gratuity/Resignation">DV - Separation Gratuity/Resignation</option>
                <option value="Transfer of Pension">DV - Transfer of Pension</option>
                <option value="Posthumus">DV - Unpaid Monthly Pension (Posthumus)</option>
...
<?php /**PATH C:\xampp\htdocs\pgmc_doc_tracking-1\resources\views/admin/new.blade.php ENDPATH**/ ?>