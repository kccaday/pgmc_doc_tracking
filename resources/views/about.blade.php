  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    <div class="flex flex-col bg-gray-200 max-w-sm shadow-md py-8 px-10 md:px-8 rounded-md">
      <div class="flex flex-col md:flex-row gap-6 md:gap-8">
        <img class="rounded-full border-4 border-gray-300 h-24 w-24 mx-auto" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FArmed_Forces_of_the_Philippines&psig=AOvVaw0EpKeSMpzjLTGTbBeJevT0&ust=1628041324844000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCJCj7dfck_ICFQAAAAAdAAAAABAD" alt="" />
        <div class="flex flex-col text-center md:text-left">
          <div class="font-medium text-lg text-gray-800">Online PenMIS Program</div>
          <div class="text-gray-500 mb-3 whitespace-nowrap">Online PenMIS Desc</div>
...
<br>
    <div class="flex flex-col bg-gray-200 max-w-sm shadow-md py-8 px-10 md:px-8 rounded-md">
      <div class="flex flex-col md:flex-row gap-6 md:gap-8">
        <img class="rounded-full border-4 border-gray-300 h-24 w-24 mx-auto" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FArmed_Forces_of_the_Philippines&psig=AOvVaw0EpKeSMpzjLTGTbBeJevT0&ust=1628041324844000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCJCj7dfck_ICFQAAAAAdAAAAABAD" alt="" />
        <div class="flex flex-col text-center md:text-left">
          <div class="font-medium text-lg text-gray-800">Online Pensioners Appointment System</div>
          <div class="text-gray-500 mb-3 whitespace-nowrap">OPAS</div>
          <div class="text-gray-500 mb-3 whitespace-nowrap">OPAS Desc</div>
          <div class="flex flex-row gap-4 text-gray-800 my-auto text-2xl mx-auto md:mx-0">
            <a class="hover:cursor-pointer hover:text-blue-500"><i class="fab fa-linkedin"></i></a>
            <a class="hover:cursor-pointer hover:text-blue-500"><i class="fab fa-facebook-square"></i></a>
            <a class="hover:cursor-pointer hover:text-blue-500"><i class="fab fa-github-square"></i></a>
...
<div class="w-full bg-purple-500 text-white">
    <div class="xl:px-40 pb-12 lg:px-20 md:px-10 sm:px-5 px-10">
        <div class="w-full pt-12 flex flex-col sm:flex-row space-y-2  justify-start">
            ...
            <div class="w-full sm:w-1/8 flex flex-col space-y-4">
                <a class="opacity-100">DEPARTMENT OF NATIONAL DEFENSE</a>
                <a class="opacity-60">Armed Forces of the Philippines</a>
                <a class="opacity-60">Philippine Navy</a>
                <a class="opacity-60">Philippine Army</a>
                <a class="opacity-60">Philippine Air Force</a>
            </div>
